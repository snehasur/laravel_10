                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                           ...
                           <a href="{{ route('admin.student.payment', $data->id) }}" class="payment" title="Payment" data-toggle="tooltip"><button>Pay {{$data->batch->course->fee}} </button></i></a>
